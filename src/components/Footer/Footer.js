...
const Footer = () => {
    return (
        <>
            <footer className="text-center px:2 md:px-20 lg:text-left bg-zinc-900 text-gray-600 bg-black">
                ...
                <div className="mx-6 py-10 text-center md:text-left">
                    ...
                    <div className="">
                        ...
                        <p className='text-sm'>
                            best travel agency in bangladesh, best visa solution in bangladesh, best tourism company in bangladesh, package tour operators in bangladesh.
                        </p>
                    </div>
                ...
                <div className="text-center p-6 bg-indigo-900">
                    <span>© 2021 Copyright : </span>
                    <a className="text-gray-600 font-semibold" href="https://tailwind-elements.com/">Imran Hossain</a>
                </div>
            </footer>
        </>
    );
